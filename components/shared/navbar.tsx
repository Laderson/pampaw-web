      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-8">
        ...
        <Link href="/" className="flex items-center gap-5 group">
          ...
          <div className="flex flex-col">
            <h1 className={`text-3xl font-black tracking-tighter transition-colors duration-500 leading-none ${
              isScrolled ? "text-neutral-900" : "text-white"
            }`}>
              PAMPAW
            </h1>
            <span className={`text-[11px] font-bold uppercase tracking-[0.4em] transition-colors duration-500 mt-1.5 ${
              isScrolled ? "text-neutral-400" : "text-neutral-300"
            }`}>
              Pet Store & Spa
            </span>
          </div>
        ...
        <nav className="hidden gap-10 lg:flex items-center">
          {["Inicio", "Servicios", "Petshop"].map((item) => (
            <Link
              key={item}
              href={item === "Inicio" ? "/" : item === "Servicios" ? "/#servicios" : "/petshop"}
              className={`text-[11px] font-black uppercase tracking-[0.25em] transition-colors duration-500 ${
                isScrolled ? "text-neutral-900 hover:text-neutral-500" : "text-white hover:text-neutral-300"
              }`}
            >
              {item}
            </Link>
          ...
          <Link
            href="/#promos"
            className={`text-[11px] font-black uppercase tracking-[0.25em] transition-colors duration-500 ${
              isScrolled ? "text-green-600 hover:text-green-500" : "text-green-400 hover:text-green-300"
            }`}
          >
            Promos
          </Link>
